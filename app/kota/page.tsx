      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
        ...
        >
          ...
          <div>
            ...
            <p className="text-sm font-sans opacity-80">Know a spot we&apos;re missing? Put it on the map.</p>
          </div>
        </Link>
        <Link
          href="/recipes"
        ...
        >
          {/* Video background - place a 5s clip at /recipe-preview.mp4 */}
          <video
            autoPlay
            loop
            muted
          ...
          <div className="relative z-10 flex items-center gap-3 p-5">
            ...
            <div>
              ...
              <p className="text-sm font-sans opacity-80">Use our recipe builder to craft your dream combo.</p>
            </div>
          </div>
        </Link>
      </div>
