...
export default function BunnyCityVendorGrid({
  vendors,
  city,
}: {
  vendors: Vendor[];
    ...
    return (
      <div className="text-center py-12">
        <p className="text-gray-500 font-sans">
          No bunny chow spots found in {city} yet.{' '}
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
      {vendors.map((vendor) => {
        const photos: string[] = vendor.photos
          ...
          : [];
        const thumb = photos[0] ?? '/placeholder-2.jpg';
        ...
        return (
          ...
          >
            <div className="relative h-40 bg-gray-100">
              <img
                src={thumb}
                alt={`Bunny Chow at ${vendor.name} in ${city}`}
