...
export default function StreetTalk({ vendorId }: { vendorId: string }) {
  ...
  async function submitReview() {
    ...
    try {
      const newReview = await createDocument(DATABASE_ID, 'reviews', {
        vendor_id: vendorId,
  ...
  return (
    <div>
      ...
      <AuthModal
        ...
        actionLabel="submit a review"
      />
      <form onSubmit={(e) => { e.preventDefault(); submitReview(); }} className="bg-white rounded-2xl shadow-md p-6 mb-8">
